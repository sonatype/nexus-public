...

{
  ...
  // NOTE: isNotModified() tests have been moved to ContentProxyFacetSupportTest
  // since the ETag-based blob reuse logic is now in the base ContentProxyFacetSupport class.
}
