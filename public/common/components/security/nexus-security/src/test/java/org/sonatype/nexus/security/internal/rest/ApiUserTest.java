    ...
    extends TestSupport
{
  ...
  @Test
  public void testToUser_withExternalRoles() {
    Set<String> roles = new HashSet<>();
    roles.add("nx-admin");

    Set<String> externalRoles = new HashSet<>();
    externalRoles.add("ldap-group1");
    externalRoles.add("ldap-group2");
