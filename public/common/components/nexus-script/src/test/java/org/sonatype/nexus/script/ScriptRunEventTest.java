...
public class ScriptRunEventTest
{
  @Test
  public void getScriptReturnsSameInstancePassedToConstructor() {
    Script script = mock(Script.class);

    ScriptRunEvent underTest = new ScriptRunEvent(script);
  ...
  public void getScriptReturnsNullWhenConstructedWithNull() {
    ScriptRunEvent underTest = new ScriptRunEvent(null);
  ...
  public void toStringUsesSubclassSimpleName() {
    ...
    assertThat(underTest.toString(), equalTo("ScriptRunEvent{script=" + script + "}"));
  }
}
