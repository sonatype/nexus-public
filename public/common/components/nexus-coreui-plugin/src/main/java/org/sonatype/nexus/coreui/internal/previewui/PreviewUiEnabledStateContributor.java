...
import static org.sonatype.nexus.common.app.FeatureFlags.PREVIEW_UI_SETTINGS_ENABLED_NAMED_VALUE;

/**
 * Exposes {@code nexus.previewui.enabled} to the frontend via {@code NX.State}.
    ...
    implements StateContributor
{
  ...
  {
    state = ImmutableMap.of("nexus.previewui.enabled", featureFlag);
  }
