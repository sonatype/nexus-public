...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    SearchDocker_OS_FieldLabel: 'OS',
    SearchDocker_Architecture_FieldLabel: 'Architecture',
    SearchDocker_Labels_FieldLabel: 'Labels',
    SearchDocker_Author_FieldLabel: 'Author',
    ...
    Repository_Facet_ProxyFacet_Conan_V1_Remote_HelpText: 'Location of the remote repository being proxied, e.g. https://center.conan.io',
    Repository_Facet_ProxyFacet_Conan_V2_Remote_HelpText: 'Location of the remote repository being proxied, e.g. https://center2.conan.io',
    ...
    Repository_Facet_ProxyFacet_R_Remote_HelpText: 'Location of the remote repository being proxied, e.g. https://cran.r-project.org',
    ...
    Repository_Facet_FirewallFacet_Title: 'Sonatype Nexus Firewall',
    Repository_Facet_FirewallFacet_Info_Message: 'Requires IQ Server connection configured in Capabilities',
    Repository_Facet_FirewallFacet_Mode_FieldLabel: 'Firewall Mode',
    Repository_Facet_FirewallFacet_Mode_HelpText: 'Select the firewall enforcement mode',
    Repository_Facet_FirewallFacet_Mode_Disabled: 'Disabled',
    Repository_Facet_FirewallFacet_Mode_Audit: 'Audit Only - allow components that violate policy',
    Repository_Facet_FirewallFacet_Mode_Quarantine: 'Quarantine - block components that violate policy',
    Repository_Facet_FirewallFacet_Mode_PCCS: 'PCCS - Quarantine, plus metadata filtering to help clients select a policy compliance version',
