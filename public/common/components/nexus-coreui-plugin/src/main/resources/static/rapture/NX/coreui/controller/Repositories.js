...
Ext.define('NX.coreui.controller.Repositories', {
  ...
  views: [
    ...
    'repository.recipe.AlpineGroup',
    'repository.recipe.AlpineHosted',
    'repository.recipe.AlpineProxy',
    'repository.recipe.AnsiblegalaxyGroup',
    'repository.recipe.AnsiblegalaxyHosted',
    'repository.recipe.AnsiblegalaxyProxy',
