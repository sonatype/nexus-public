      ...
      {!loadingRules && !error && sortedRules.length > 0 && (
        <Box className="routing-rules-list__table-wrapper">
          <table className="routing-rules-list__table">
            <thead>
              <tr>
                <th onClick={() => handleSort('name')} className="routing-rules-list__th routing-rules-list__th--sortable">
                  <Flex align="center" gap="1">
                    Name
                    {renderSortIcon('name')}
                  </Flex>
                </th>
                <th onClick={() => handleSort('description')} className="routing-rules-list__th routing-rules-list__th--sortable">
                  <Flex align="center" gap="1">
                    Description
                    {renderSortIcon('description')}
                  </Flex>
                </th>
                <th onClick={() => handleSort('mode')} className="routing-rules-list__th routing-rules-list__th--sortable routing-rules-list__th--mode">
                  <Flex align="center" gap="1">
                    Mode
                    {renderSortIcon('mode')}
                  </Flex>
                </th>
                <th onClick={() => handleSort('assignedRepositoryCount')} className="routing-rules-list__th routing-rules-list__th--sortable routing-rules-list__th--repos">
                  <Flex align="center" gap="1">
                    Repositories
              ...
              {sortedRules.map((rule) => (
                ...
                >
                  ...
                  <td className="routing-rules-list__td routing-rules-list__td--action">
                    <Pencil size={16} className="routing-rules-list__row-edit-icon" />
                  </td>
                </tr>
              ))}
            </tbody>
