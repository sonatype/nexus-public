...
const BASE_PATH = 'preview/admin/repository/cleanuppolicies';

/**
 * URL-based routing patterns:
 * - /cleanuppolicies           → List page
 * - /cleanuppolicies/create    → Create form
 * - /cleanuppolicies/{name}    → Edit form
 */
...
function parseRoute(hash: string): RouteState {
  ...
  // Find the cleanuppolicies segment
  const policiesIndex = parts.indexOf('cleanuppolicies');
  if (policiesIndex === -1) {
  ...
  // /cleanuppolicies/{name} → detail/edit
  return {
    viewMode: 'detail',
 ...
 *
 * URL patterns:
 * - #preview/admin/repository/cleanuppolicies           → List
 * - #preview/admin/repository/cleanuppolicies/create    → Create form
 * - #preview/admin/repository/cleanuppolicies/{name}    → Edit form
 */
