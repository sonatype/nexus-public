...
describe('SettingsToggle', () => {
  ...
  describe('state text', () => {
    it('shows checked text when checked and checkedText is provided', () => {
      render(
        <SettingsToggle
          {...defaultProps}
          checked={true}
    ...
    it('shows unchecked text when unchecked and uncheckedText is provided', () => {
      render(
        <SettingsToggle
          {...defaultProps}
          checked={false}
    ...
    it('does not show state text when props are not provided', () => {
      render(<SettingsToggle {...defaultProps} />);
      expect(screen.queryByText('Enabled')).not.toBeInTheDocument();
      expect(screen.queryByText('Disabled')).not.toBeInTheDocument();
    });

    it('applies checked styling to state text when checked', () => {
      const { container } = render(
        <SettingsToggle
          {...defaultProps}
          checked={true}
      ...
      expect(container.querySelector('.settings-toggle__state-text--checked')).toBeInTheDocument();
    });

    it('applies unchecked styling to state text when unchecked', () => {
      const { container } = render(
        <SettingsToggle
          {...defaultProps}
          checked={false}
      ...
      expect(container.querySelector('.settings-toggle__state-text--unchecked')).toBeInTheDocument();
    });
  });
});
