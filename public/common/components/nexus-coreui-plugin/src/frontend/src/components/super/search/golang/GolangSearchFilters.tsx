...
export interface GolangSearchFiltersProps {
  values: FilterValues;
...
export function GolangSearchFilters({
  values,
  onChange,
  onSearch,
  onClear,
  loading = false,
}: GolangSearchFiltersProps): JSX.Element {
  ...
  const hasAdvancedFilters = Boolean(values.version || values.keyword);
          ...
          <Flex direction="column" gap="3">
            <Flex gap="3" wrap="wrap">
              ...
              <Box style={{ flex: '1 1 200px' }}>
                <Text as="label" size="1" color="gray" mb="1">Keyword</Text>
                <TextField.Root
...
export default GolangSearchFilters;
