...
// @ts-ignore
import { useContentSelectorsApi } from '@/components/super/settings/repository/selectors/useContentSelectorsApi';
// @ts-ignore
import { useRepositoryTree } from '@/components/super/settings/repository/repositories/useRepositoryTree';

// Mock dependencies
jest.mock('@/components/super/settings/repository/selectors/useContentSelectorsApi');
jest.mock('@/components/super/settings/repository/repositories/useRepositoryTree');
jest.mock('@/components/super/settings/repository/repositories/components/FormatIcon', () => ({
  FormatIcon: () => <div data-testid="format-icon" />
}));
jest.mock('@/components/super/settings/repository/selectors/ContentSelectorPreview', () => ({
  ContentSelectorPreview: () => <div data-testid="content-selector-preview" />
}));
jest.mock('@/components/super/browse/browse.api', () => ({
  fetchBrowseNodes: jest.fn().mockResolvedValue([]),
}));
jest.mock('@/components/super/settings/repository/selectors/cselValidator', () => ({
