...
import { HealthCheckCell } from '@/components/shared/security/HealthCheckCell';
import { FirewallCell as IqPolicyViolationsCell } from '../../../../../components/shared/security/FirewallCell';
...
describe('HealthCheckCell', () => {
  ...
  it('renders N/A for non-proxy repositories', () => {
    renderWithTheme(
