...
// Deep source import (not the barrel) is intentional; jest.config.js maps it to one
// transformed instance. A barrel export of usageHelperUtils would drop both (NEXUS-54019).
import {
  OVER_LIMITS,
  NEAR_LIMITS,
  UNDER_LIMITS,
...
} from '@sonatype/nexus-ui-plugin/src/frontend/src/components/widgets/SystemStatusAlerts/CELimits/usageHelperUtils';

// Re-export the shared constants and helpers so existing consumers of this
// module keep importing them from here.
export {
  OVER_LIMITS,
  NEAR_LIMITS,
  UNDER_LIMITS,
...
// Internal implementation detail - returns the raw Date object.
// Public consumers should use useGracePeriodEndDate() instead, which formats the date.
