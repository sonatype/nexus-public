 ...
 * - Format: 24 format sub-states in a parallel region, each declaring filter metadata
 *
 * Format sub-states enable:
 * 1. Tests that verify every format's filter config (it.each over 24 formats)
  ...
  return createMachine<SearchMachineContext, SearchMachineEvent>(
    {
      ...
      states: {
        ...
        // ==================================================
        // Format Region - 24 format sub-states with metadata
        // ==================================================
        format: {
          initial: 'all',
