...
describe('RoleForm', () => {
  ...
  describe('Validation', () => {
    it('should call onValidationChange with false if Step 1 is invalid', async () => {
      ...
      renderWithTheme(
        <RoleForm isCreate={true} onCancel={mockOnCancel} wizardStep={0} onValidationChange={mockOnValidationChange} />
      );
    ...
    it('should show warning when no privileges or roles are selected on step 2 after attempt', async () => {
    ...
    it('should require at least one privilege or role on step 2', async () => {
      ...
      // Render on step 2 with no privileges - button should be disabled
      renderWithTheme(
        <RoleForm isCreate={true} onCancel={mockOnCancel} wizardStep={2} />
      );
  ...
  describe('Create with no privilege - P0 validation', () => {
    it('shows validation error when Save clicked with no privileges on step 2', async () => {
    ...
    it('does not show privilege warning when privileges are selected', async () => {
      ...
      renderWithTheme(
        <RoleForm isCreate={true} onCancel={mockOnCancel} wizardStep={2} hideActions />
      );
