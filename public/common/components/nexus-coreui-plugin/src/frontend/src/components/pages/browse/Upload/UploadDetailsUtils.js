...
export const TERRAFORM_MODULE_COORDS_GROUP_HELP = 'Applicable only when the Upload Type is Module';
export const TERRAFORM_PROVIDER_COORDS_GROUP_HELP = 'Applicable only when the Upload Type is Provider';
