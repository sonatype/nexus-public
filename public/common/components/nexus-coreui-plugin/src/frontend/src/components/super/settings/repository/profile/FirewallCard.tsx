...
import type { FirewallData, IqCapabilities, MalwareCleanupSummary } from './hooks/useRepositoryProfile';
import { useFirewallEnable, fetchIqAuditStatus } from '@/components/shared/security/useFirewallEnable';
import {
  setMalwareRemediatorEnabledForRepository,
  type MalwareRemediatorMode,
} from '@/components/shared/security/malwareRemediatorTask';
