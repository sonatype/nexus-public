...
export function RepositoryForm({
  ...
  const { form, repository: loadedRepository } = useRepositoryForm({
    ...
    repositoryType: recipe.type as any,
    onSave,
    onCancel,
    createRepository,
    updateRepository,
  ...
  }, [onSubmitRef, form, form.isLoading, form.isSaving]);
  ...
  useEffect(() => {
    ...
    if (form.data) {
      const errors = validateRepository(form.data as RepositoryFormData);
      onCanAdvanceChange(!hasFormErrors(errors));
    }
  }, [form.data, form.isLoading, onCanAdvanceChange]);
  ...
  const showRoutingRuleFacet = recipe.type === 'proxy' || recipe.type === 'group';
    ...
    <Box>
      {/* Repository Info Section */}
        ...
        <StorageFacet
          ...
          showWritePolicy={showHostedFacets}
        />
