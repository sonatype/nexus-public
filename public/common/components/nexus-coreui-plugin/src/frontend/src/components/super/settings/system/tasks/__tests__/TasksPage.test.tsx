...
// Mock @sonatype/nexus-ui-plugin - get the mock from global setup
...
jest.mock('../../../../../shared', () => ({
  ...
  PageHeader: jest.fn(({ title }) => require('react').createElement('div', null, require('react').createElement('h1', null, title))),
  LoadingState: jest.fn(({ message }) => require('react').createElement('div', null, message || 'Loading...')),
}));
