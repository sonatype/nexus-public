...
import { useFirewallEnable } from '@/components/shared/security/useFirewallEnable';
      ...
      <Card size="2">
        <Flex direction="column" gap="4">
          <Flex align="center" gap="3">
            <Shield size={28} color="var(--orange-9)" aria-hidden />
            <Box>
            ...
            <Box>
              {isDeferred && (
                <Text size="2" color="gray" mb="2" as="div">
                  {value === 'none'
                    ? 'Current choice: None (skip for now)'
                    : value === 'audit'
