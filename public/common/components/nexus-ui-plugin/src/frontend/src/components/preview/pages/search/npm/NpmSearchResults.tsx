...
export interface NpmSearchResultsProps {
  /** Search results to display */
  results: readonly NpmResult[];
...
/**
 * Results table component for npm search.
 */
export function NpmSearchResults({
  results,
  loading,
  error,
  totalCount,
  onSelect,
}: NpmSearchResultsProps): JSX.Element {
  // Loading state
    ...
    return (
      <Flex justify="center" align="center" p="6">
        <Flex direction="column" align="center" gap="3">
          <Spinner size="3" />
          <Text color="gray">Searching npm packages...</Text>
        </Flex>
      </Flex>
    );
  }
...
export default NpmSearchResults;
