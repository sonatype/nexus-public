...
describe('UploadFormContainer', () => {
  ...
  it('renders component field groups', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Component coordinates' })).toBeInTheDocument();
  ...
  it('navigates back when back button is clicked', async () => {
    ...
    const backButton = screen.getByText('Upload');
  ...
  it('renders help text for fields', () => {
    ...
    expect(screen.getByText('The Maven group ID')).toBeInTheDocument();
  });
