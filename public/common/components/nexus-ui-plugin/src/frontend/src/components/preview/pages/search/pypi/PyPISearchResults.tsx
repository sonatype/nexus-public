...
export interface PyPISearchResultsProps {
  /** Search results to display */
  results: readonly PyPIResult[];
...
/**
 * Results table component for PyPI search.
 */
export function PyPISearchResults({
  results,
  loading,
  error,
  totalCount,
  onSelect,
}: PyPISearchResultsProps): JSX.Element {
  // Loading state
    ...
    return (
      <Flex justify="center" align="center" p="6">
        <Flex direction="column" align="center" gap="3">
          <Spinner size="3" />
          <Text color="gray">Searching PyPI packages...</Text>
        </Flex>
      </Flex>
    );
  }
        ...
        <Table.Body>
          {results.map((result) => (
            ...
            >
              ...
              <Table.Cell>
                <Text size="2" color="gray">{result.author || '-'}</Text>
              </Table.Cell>
              <Table.Cell>
                <Text size="2" color="gray">
...
export default PyPISearchResults;
