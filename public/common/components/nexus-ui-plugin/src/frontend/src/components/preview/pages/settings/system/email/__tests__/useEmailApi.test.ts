...
// Mock at the relative path used by the source
...
jest.mock('../../../../../../../interface/api', () => ({
  ...
  urlBuilder: {
    email: {
      get: jest.fn(() => '/service/rest/v1/email'),
      update: jest.fn(() => '/service/rest/v1/email'),
      verify: jest.fn(() => '/service/rest/v1/email/verify'),
    },
  },
}));
