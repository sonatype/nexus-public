...
import static org.sonatype.nexus.repository.pypi.tasks.PyPiDeleteLegacyProxyAssetsTaskDescriptor.TYPE_ID;
...
public class PyPiDeleteLegacyProxyAssetsService
    extends LifecycleSupport
{
  ...
  @Inject
  public PyPiDeleteLegacyProxyAssetsService(
