...
@Named
@Singleton
@Path(RepositoriesApiResource.RESOURCE_URI + "/pypi/hosted")
public class PypiHostedRepositoriesApiResource
    extends AbstractRepositoriesApiResource<PypiHostedRepositoryApiRequest>
{
  @Inject
  public PypiHostedRepositoriesApiResource(
      final AuthorizingRepositoryManager authorizingRepositoryManager,
      final AbstractRepositoryApiRequestToConfigurationConverter<PypiHostedRepositoryApiRequest> configurationAdapter
  )
  {
