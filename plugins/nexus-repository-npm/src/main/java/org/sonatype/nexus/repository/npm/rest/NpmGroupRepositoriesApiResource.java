...
import static org.sonatype.nexus.repository.npm.rest.NpmGroupRepositoriesApiResource.RESOURCE_URI;
...
@Singleton
@Path(RESOURCE_URI)
public class NpmGroupRepositoriesApiResource
    extends AbstractGroupRepositoriesApiResource<NpmGroupRepositoryApiRequest>
{
  public static final String RESOURCE_URI = RepositoriesApiResource.RESOURCE_URI + "/npm/group";

  @Inject
  public NpmGroupRepositoriesApiResource(
      final AuthorizingRepositoryManager authorizingRepositoryManager,
      final GroupRepositoryApiRequestToConfigurationConverter<NpmGroupRepositoryApiRequest> configurationAdapter,
