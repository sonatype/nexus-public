...
@Named
@Singleton
@Path(RepositoriesApiResource.RESOURCE_URI + "/npm/proxy")
public class NpmProxyRepositoriesApiResource
    extends AbstractRepositoriesApiResource<NpmProxyRepositoryApiRequest>
{
  @Inject
  public NpmProxyRepositoriesApiResource(
