...
public class NpmHostedFacetImplTest extends TestSupport
{
  @Rule
  public TemporaryFolder tempFolderRule = new TemporaryFolder();

  private NpmHostedFacetImpl underTest;
  ...
  public void setup() throws Exception {
    underTest = new NpmHostedFacetImpl(npmRequestParser);
  ...
  public void putPackage_payload_newPackage() throws IOException, URISyntaxException {
    try (InputStream is = ArchiveUtils.pack(tempFolderRule.newFile(),
        new File(NpmUploadHandlerTest.class.getResource("internal/package.json").toURI()), "package/package.json")) {
  ...
  public void putPackage_payload_notNpm() throws IOException, URISyntaxException {
    try {
      ...
      when(tempBlob.get())
          .thenAnswer(i -> NpmHostedFacetImplTest.class.getResource("package-without-json.tgz").toURI());
