...
import org.sonatype.nexus.repository.r.rest.RProxyRepositoriesApiResource;
...
/**
 * @since 3.28
 * @deprecated - prefer to use {@link OrientRProxyRepositoriesApiResourceV1 } instead of Beta.
 */
...
@Api(hidden = true)
@Deprecated
public class OrientRProxyRepositoriesApiResourceBeta
