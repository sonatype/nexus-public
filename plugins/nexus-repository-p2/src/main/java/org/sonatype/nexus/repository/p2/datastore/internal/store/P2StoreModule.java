 ...
 */
package org.sonatype.nexus.repository.p2.datastore.internal.store;
...
public class P2StoreModule
    extends BespokeFormatStoreModule<ContentRepositoryStore<P2ContentRepositoryDAO>,
                                     ComponentStore<P2ComponentDAO>,
                                     AssetStore<P2AssetDAO>,
                                     AssetBlobStore<P2AssetBlobDAO>>
{
  // nothing to add...
}
