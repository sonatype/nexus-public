    ...
    extends TestSupport
{
  ...
  @Mock
  private RawReplicationIngesterHelper rawReplicationIngesterHelper;
  ...
  public void setup() {
    ...
    underTest = new RawReplicationIngester(blobStoreManager, rawReplicationIngesterHelper);
  }

  @Test
  public void extractAttributesFromProperties() {
    Map<String, Object> extractedProperties = underTest.extractAttributesFromProperties(getProperties());
  ...
  public void ingestCallsDeleteIfDeleteEvent() {
    ...
    verify(rawReplicationIngesterHelper, times(1)).deleteReplication("blobName", "repositoryName");
  }

  @Test
  public void ingestCallsReplicateIfAddEvent() throws IOException {
    underTest.ingestBlob("blobId", "blobStoreId", "repositoryName", BlobEventType.ADDED);
    verify(rawReplicationIngesterHelper, times(1))
        .replicate(any(String.class), any(Blob.class), any(Map.class), any(String.class), any(String.class));
  }
