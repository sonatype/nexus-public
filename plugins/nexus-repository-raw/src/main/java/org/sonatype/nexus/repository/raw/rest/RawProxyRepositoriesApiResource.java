...
import static org.sonatype.nexus.repository.raw.rest.RawProxyRepositoriesApiResource.RESOURCE_URI;
...
@Singleton
@Path(RESOURCE_URI)
public class RawProxyRepositoriesApiResource
    extends AbstractRepositoriesApiResource<RawProxyRepositoryApiRequest>
{
  public static final String RESOURCE_URI = RepositoriesApiResource.RESOURCE_URI + "/raw/proxy";

  @Inject
  public RawProxyRepositoriesApiResource(
      final AuthorizingRepositoryManager authorizingRepositoryManager,
      final AbstractRepositoryApiRequestToConfigurationConverter<RawProxyRepositoryApiRequest> configurationAdapter)
  {
