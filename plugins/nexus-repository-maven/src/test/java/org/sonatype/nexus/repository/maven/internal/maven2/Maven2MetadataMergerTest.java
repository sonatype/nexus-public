...
/**
 * UT for {@link Maven2MetadataMerger}
 *
 * @since 3.0
 */
public class Maven2MetadataMergerTest
    extends TestSupport
{
  private final Maven2MetadataMerger merger = new Maven2MetadataMerger();
  ...
  public void groupLevelMd() throws Exception {
    ...
    final Metadata m = merger.merge(
        ImmutableList.of(new MetadataEnvelope("1", m1), new MetadataEnvelope("2", m2), new MetadataEnvelope("3", m3))
    );
