...
import static org.sonatype.nexus.repository.maven.rest.MavenGroupRepositoriesApiResource.RESOURCE_URI;
...
@Singleton
@Path(RESOURCE_URI)
public class MavenGroupRepositoriesApiResource
    extends AbstractGroupRepositoriesApiResource<MavenGroupRepositoryApiRequest>
{
  public static final String RESOURCE_URI = RepositoriesApiResource.RESOURCE_URI + "/maven/group";

  @Inject
  public MavenGroupRepositoriesApiResource(
