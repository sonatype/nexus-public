...
@Named
@Singleton
@Path(RepositoriesApiResource.RESOURCE_URI + "/maven/hosted")
public class MavenHostedRepositoriesApiResource
    extends AbstractRepositoriesApiResource<MavenHostedRepositoryApiRequest>
    implements Resource, MavenHostedRepositoriesApiResourceDoc
{
  @Inject
  public MavenHostedRepositoriesApiResource(
