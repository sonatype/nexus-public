...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    ' for which is appropriate for your use case.<em/>',
    Repository_Facet_DockerConnectorFacet_HttpPort_FieldLabel: 'HTTP',
    Repository_Facet_DockerConnectorFacet_HttpPort_HelpText: 'Create an HTTP connector at specified port. Normally used if Nexus is behind a secure proxy.',
    Repository_Facet_DockerConnectorFacet_HttpsPort_FieldLabel: 'HTTPS',
    Repository_Facet_DockerConnectorFacet_HttpsPort_HelpText: 'Create an HTTPS connector at specified port. Normally used if Nexus is configured for https.',
    ...
    Repository_Facet_DockerProxyFacet_IndexUrl_HelpText: 'Location of Docker Index to be used',
    ...
    Ssl_SslUseTrustStore_Certificate_HelpText: 'Use certificates stored in Nexus to connect to external systems',
