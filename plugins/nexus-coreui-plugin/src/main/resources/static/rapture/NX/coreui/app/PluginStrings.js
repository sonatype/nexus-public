...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    RoutingRules_Mode_Allow_Text: 'Allow requests that match any',
    RoutingRules_Mode_Block_Text: 'Block requests that match any',
    RoutingRules_Rule_Label: 'Rule',
    RoutingRules_Matchers_Label: 'Matchers:',
    RoutingRules_Matchers_Add_Button: 'Add matcher',
