...
/**
 * Configuration for Conan group repositories.
 *
 * @since 3.74
 */
Ext.define('NX.coreui.view.repository.facet.ConanGroupFacet', {
  extend: 'Ext.form.FieldContainer',
  alias: 'widget.nx-coreui-repository-conangroup-facet',
  requires: [
    'NX.I18n',
    'NX.State',
    'NX.Icons'
    ...
    me.items = [
      {
        xtype: 'fieldset',
        cls: 'nx-form-section',
        title: NX.I18n.get('Repository_Facet_ConanGroupFacet_Title'),
        ...
        items: [
          {
            xtype: 'label',
            cls: 'description',
            html: NX.I18n.get('Repository_Facet_ConanGroupFacet_HelpLink'),
            style: {
              fontSize: '12px',
            }
          },
          {
            xtype: 'radiogroup',
            name: 'conanVersion',
            fieldLabel: NX.I18n.get('Repository_Facet_ConanGroupFacet_ProtocolVersion'),
            columns: 1,
            vertical: true,
            items: [
              {
                boxLabel: NX.I18n.get('Repository_Facet_ConanGroupFacet_V1'),
                name: 'attributes.conan.conanVersion',
                inputValue: 'V1'
              },
              {
                boxLabel: NX.I18n.get('Repository_Facet_ConanGroupFacet_V2'),
                name: 'attributes.conan.conanVersion',
                inputValue: 'V2'
              }
            ],
          ...
          },
          {
            ...
            title: NX.I18n.get('Repository_Facet_ConanGroupFacet_HelpText')
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            itemId: 'version',
            labelAlign: 'left',
            fieldLabel: NX.I18n.get('Repository_Facet_ConanGroupFacet_Version'),
            readOnly: true,
            listeners: {
