 ...
 */
package org.sonatype.nexus.plugins.p2bridge;
    ...
    extends PluginIdentity
{
   ...
   */
  @NonNls
  public static final String ID_PREFIX = "p2-bridge";
  ...
  @Inject
  public P2BridgePlugin() throws Exception {
