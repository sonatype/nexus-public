...
import static org.sonatype.nexus.repository.cocoapods.rest.CocoapodsProxyRepositoriesApiResource.RESOURCE_URI;
...
@Singleton
@Path(RESOURCE_URI)
public class CocoapodsProxyRepositoriesApiResource
    extends AbstractRepositoriesApiResource<CocoapodsProxyRepositoryApiRequest>
{
  public static final String RESOURCE_URI = RepositoriesApiResource.RESOURCE_URI + "/cocoapods/proxy";

  @Inject
  public CocoapodsProxyRepositoriesApiResource(
