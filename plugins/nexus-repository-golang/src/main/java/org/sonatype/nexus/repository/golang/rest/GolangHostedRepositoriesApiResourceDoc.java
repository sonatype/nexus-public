...
public interface GolangHostedRepositoriesApiResourceDoc
{
  ...
  Response createRepository(@Valid @NotNull final GolangHostedRepositoryApiRequest request);
  ...
  Response updateRepository(
      @Valid @NotNull final GolangHostedRepositoryApiRequest request,
