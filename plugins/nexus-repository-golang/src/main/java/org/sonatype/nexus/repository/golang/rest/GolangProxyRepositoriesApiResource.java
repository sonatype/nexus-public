...
import static org.sonatype.nexus.repository.golang.rest.GolangProxyRepositoriesApiResource.RESOURCE_URI;
...
@Singleton
@Path(RESOURCE_URI)
public class GolangProxyRepositoriesApiResource
    extends AbstractRepositoriesApiResource<GolangProxyRepositoryApiRequest>
    implements Resource, GolangProxyRepositoriesApiResourceDoc
{
  public static final String RESOURCE_URI = RepositoriesApiResource.RESOURCE_URI + "/go/proxy";

  @Inject
  public GolangProxyRepositoriesApiResource(
