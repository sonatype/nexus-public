 ...
 */
package org.sonatype.nexus.repository.golang.internal.datastore.group
...
{
  public static final String NAME = 'go-group'
  ...
  @Inject
  GoGroupRecipe(@Named(GroupType.NAME) final Type type,
