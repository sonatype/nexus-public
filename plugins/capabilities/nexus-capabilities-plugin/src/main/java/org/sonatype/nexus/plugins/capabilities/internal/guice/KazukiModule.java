...
/**
 * Capabilities plugin Kazuki Guice module. Installed by {@link GuiceModule} if Kazuki present.
 *
 * @since 2.13.1
 */
public class KazukiModule
    extends AbstractModule
{
  @Override
  protected void configure() {
    bind(KazukiCapabilityStorage.class).in(Singleton.class);
    bind(CapabilityStorageConverter.class).to(KazukiCapabilityStorageConverter.class).in(Singleton.class);
