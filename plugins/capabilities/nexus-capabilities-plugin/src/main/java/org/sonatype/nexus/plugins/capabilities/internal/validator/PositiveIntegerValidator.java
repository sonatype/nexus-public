    ...
    implements Validator
{
  ...
  {
    @DefaultMessage("%s is a positive integer value")
    String valid(String fieldLabel);

    @DefaultMessage("%s is not a positive integer value")
    String invalid(String fieldLabel);

    @DefaultMessage("%s is not a positive integer value (%s)")
    String invalidReason(String fieldLabel, String failure);

    @DefaultMessage("%s is not a positive integer value (<0)")
    String invalidReasonLTZero(String fieldLabel);
  }
  ...
  @Inject
  public PositiveIntegerValidator(final Provider<CapabilityDescriptorRegistry> capabilityDescriptorRegistryProvider,
