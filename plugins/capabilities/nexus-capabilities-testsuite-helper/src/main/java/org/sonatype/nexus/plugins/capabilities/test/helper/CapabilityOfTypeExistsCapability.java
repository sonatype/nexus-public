    ...
    implements Capability
{
  ...
  @Inject
  public CapabilityOfTypeExistsCapability(final Conditions conditions) {
    this.conditions = conditions;
  }

  @Override
  public Condition activationCondition() {
    return conditions.capabilities().capabilityOfTypeExists(MessageCapabilityDescriptor.TYPE);
  }
