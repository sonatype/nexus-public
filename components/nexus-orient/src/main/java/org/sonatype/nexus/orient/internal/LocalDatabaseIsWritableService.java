...
import org.sonatype.nexus.orient.DatabaseIsWritableService;
...
public class LocalDatabaseIsWritableService
    ...
    implements DatabaseIsWritableService
{
  private final DatabaseFreezeService freezeService;

  @Inject
  public LocalDatabaseIsWritableService(final DatabaseFreezeService freezeService) {
