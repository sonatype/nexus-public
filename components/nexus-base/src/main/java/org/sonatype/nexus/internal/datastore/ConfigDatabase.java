...
/**
 * Add {@link SupportBundle} to export configuration data to serialized files.
 *
 * @since 3.29
 */
@Named
    ...
    implements SupportBundleCustomizer
{
  ...
  @Inject
  public ConfigDatabase(final Map<String, ExportData> exportDataByName) {
  ...
  private GeneratedContentSourceSupport getExporter(final String fileName, final ExportData exporter) {
