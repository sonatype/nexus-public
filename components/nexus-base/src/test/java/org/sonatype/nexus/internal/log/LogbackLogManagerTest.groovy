    ...
    extends TestSupport
{
  ...
  void 'customizer sets logger level'() {
    ...
    def underTest = new LogbackLogManager(mock(BeanLocator.class), new MemoryLoggerOverrides())
  ...
  void 'overrides sets logger level when customizer is present'() {
    ...
    def underTest = new LogbackLogManager(mock(BeanLocator.class), overrides)
