...
@Named
@Singleton
public class OrientConfigurationSubscriber
    ...
    implements EventAware
{
  ...
  @Inject
  public OrientConfigurationSubscriber(final RepositoryManager repositoryManager) {
    this.repositoryManager = checkNotNull(repositoryManager);
  }

  @Subscribe
  public void on(final ConfigurationCreatedEvent event) {
    handleReplication(event, e -> repositoryManager.create(e.getConfiguration()));
  }

  @Subscribe
  public void on(final ConfigurationUpdatedEvent event) {
    handleReplication(event, e -> repositoryManager.update(e.getConfiguration()));
  }
