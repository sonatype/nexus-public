 ...
 * response
 * error code and body, thus allowing to simulate error pages too.
 */
public class DeliverBehaviour
    implements Behaviour
{
   ...
   * Constructor.
   */
  public DeliverBehaviour(final int code, final String bodyContentType, final String body) {
    this.code = code;
