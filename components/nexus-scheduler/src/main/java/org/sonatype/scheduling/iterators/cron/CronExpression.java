 ...
 * respectively are described as follows: <table cellspacing="8">
 * <tr>
 ...
 * &quot;last&quot;, but it has different meaning in each of the two fields. For example, the value &quot;L&quot; in
 * the
 ...
 * (day 6 = Friday and &quot;#3&quot; = the 3rd one in the month). Other examples: &quot;2#1&quot; = the first Monday
 * of
 ...
 * then it is equivalent to having an all-inclusive calendar. A value of "5C" in the day-of-month field means "the
 * first
 ...
 * might do 22-2 to catch 10 o'clock at night until 2 o'clock in the morning, or you might have NOV-FEB. It is very
 * important to note that overuse of overflowing ranges creates ranges that don't make sense and no effort has been
 * made
 * to determine which interpretation CronExpression chooses. An example would be "0 0 14-6 ? * FRI-MON". </li>
 * </ul>
 * </p>
 *
