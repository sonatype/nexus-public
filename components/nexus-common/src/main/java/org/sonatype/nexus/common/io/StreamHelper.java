...
// FIXME: Resolve the usefulness of this class, its used only by ServletHelper

/**
 * Offers static helper methods for common stream related operations.
 *
 * @since 2.7.0
 */
public final class StreamHelper
{
  ...
  public static final int BUFFER_SIZE = SystemPropertiesHelper.getInteger(
      StreamHelper.class.getName() + ".BUFFER_SIZE", 8192
  );
