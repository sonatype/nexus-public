 ...
 * @since 3.0
 */
public class TcclWrapperFactory
{
  private TcclWrapperFactory() {
    // empty
  }

  /**
   * Creates a dynamic-proxy for type, delegating to target and setting the TCCL to classloader before invocation.
   */
