...
public abstract class DatastoreSqlTransformerTest
    extends TestSupport
{
  protected final JexlEngine jexlEngine = new JexlEngine();

  SelectorSqlBuilder builder;

  public abstract DatastoreSqlTransformer getTransformer();
