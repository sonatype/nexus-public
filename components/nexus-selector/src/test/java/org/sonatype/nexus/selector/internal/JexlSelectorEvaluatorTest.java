...
public class JexlSelectorEvaluatorTest
    extends TestSupport
{
  @Mock
  ...
  public void testEvaluate() throws Exception {
    JexlSelectorEvaluator jexlSelectorEvaluator = new JexlSelectorEvaluator();

    SelectorConfiguration selectorConfiguration = getSelectorConfiguration("jexl", "true");
    assertThat(jexlSelectorEvaluator.evaluate(selectorConfiguration, variableSource), is(true));
  }
  ...
  public void testEvaluateFailed() throws Exception {
    ...
    assertThat(jexlSelectorEvaluator.evaluate(selectorConfiguration, variableSource), is(false));
  }
  ...
  public void testEvaluate_invalidSelectorType() throws Exception {
    ...
    jexlSelectorEvaluator.evaluate(selectorConfiguration, variableSource);
  }
