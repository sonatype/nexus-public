    ...
    extends OSQLFunctionAbstract
{
  ...
  private final VariableResolverAdapter simpleVariableResolverAdapter;

  private final Map<String, VariableResolverAdapter> variableResolverAdapters;
  ...
  public ContentAuth(@Nonnull final SelectorConfigurationStore selectorConfigurationStore,
                     ...
                     @Nonnull final Map<String, VariableResolverAdapter> variableResolverAdapters)
  {
    super(NAME, 1, 1);
    this.selectorConfigurationStore = checkNotNull(selectorConfigurationStore);
    this.contentPermissionChecker = checkNotNull(contentPermissionChecker);
    this.variableResolverAdapters = checkNotNull(variableResolverAdapters);
    this.simpleVariableResolverAdapter = checkNotNull(variableResolverAdapters.get("simple"));
  }
