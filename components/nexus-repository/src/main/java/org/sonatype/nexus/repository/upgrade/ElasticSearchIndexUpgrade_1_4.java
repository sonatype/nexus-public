...
@Named
@Singleton
@Upgrades(model = ElasticSearchIndexCheckpoint.MODEL, from = "1.3", to = "1.4")
public class ElasticSearchIndexUpgrade_1_4
    extends ElasticSearchIndexUpgradeSupport
{
  @Inject
  public ElasticSearchIndexUpgrade_1_4(final ApplicationDirectories applicationDirectories) {
