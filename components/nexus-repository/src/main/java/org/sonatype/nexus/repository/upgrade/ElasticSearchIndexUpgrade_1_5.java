...
@Named
@Singleton
@Upgrades(model = ElasticSearchIndexCheckpoint.MODEL, from = "1.4", to = "1.5")
public class ElasticSearchIndexUpgrade_1_5
    extends ElasticSearchIndexUpgradeSupport
{
  @Inject
  public ElasticSearchIndexUpgrade_1_5(final ApplicationDirectories applicationDirectories) {
