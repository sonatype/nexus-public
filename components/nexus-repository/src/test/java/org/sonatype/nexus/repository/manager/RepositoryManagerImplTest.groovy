    ...
    extends TestSupport
{
  ...
  public void setup() {
    ...
    mockRepository(mavenCentralConfiguration, mavenCentralRepository, 'maven-central')
    mockRepository(apacheSnapshotsConfiguration, apacheSnapshotsRepository, 'apache-snapshots')
    mockRepository(thirdPartyConfiguration, thirdPartyRepository, 'third-party')
  ...
  private void mockRepository(Configuration configuration, Repository repository, String name) {
