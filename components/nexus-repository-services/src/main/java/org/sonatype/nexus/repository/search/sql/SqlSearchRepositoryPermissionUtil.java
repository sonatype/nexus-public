...
@Named
@Singleton
public class SqlSearchRepositoryPermissionUtil
    extends ComponentSupport
{
  ...
  @Inject
  public SqlSearchRepositoryPermissionUtil(
  ...
  public Set<String> browsableAndUnknownRepositories(final String format, final Set<String> repositories) {
    ...
    */
    for (String repositoryName : repositories) {
      if (!repositoryManager.exists(repositoryName) ||
          securityHelper.allPermitted(new RepositoryViewPermission(format, repositoryName, BROWSE))) {
        browsableAndUnknownRepositories.add(repositoryName);
      }
    }
      ...
      final List<String> formats)
  {
    ...
    List<SelectorConfiguration> selectors = selectorManager.browseActive(repositories, formats).stream()
