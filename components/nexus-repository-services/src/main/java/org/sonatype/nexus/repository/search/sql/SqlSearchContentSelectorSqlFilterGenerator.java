 ...
 */
@Singleton
public class SqlSearchContentSelectorSqlFilterGenerator
    extends ComponentSupport
{
  ...
  @Inject
  public SqlSearchContentSelectorSqlFilterGenerator(
      ...
      final String format)
  {
    ...
    SelectorSqlBuilder selectorSqlBuilder = createSelectorSqlBuilder(format);
  ...
  private static SelectorSqlBuilder createSelectorSqlBuilder(final String format) {
