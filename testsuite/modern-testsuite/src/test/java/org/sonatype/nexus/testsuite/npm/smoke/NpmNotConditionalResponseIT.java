...
/**
 * Smoke IT for npm package metadata.
 ...
 * Any request to get NPM package metadata should return 200 response code, even if inbound client headers provide If-Modified-Since
 */
@Category(External.class)
public class NpmNotConditionalResponseIT
    extends NpmMockRegistryITSupport
{
  private static final String NPM_REGISTRY_URL = "https://registry.npmjs.org";

  public NpmNotConditionalResponseIT(final String nexusBundleCoordinates) {
