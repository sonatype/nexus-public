...
/**
 * The "Shoes4 roundtrip" scenario trial.
 */
public class Shoes4Trial
    extends TrialSupport
{
  public Shoes4Trial(final String nexusBundleCoordinates) {
  ...
  protected ScenarioSupport createScenario() {
    ...
    return new Shoes4Scenario(workdir.getName(), workdir, client());
  }
}
