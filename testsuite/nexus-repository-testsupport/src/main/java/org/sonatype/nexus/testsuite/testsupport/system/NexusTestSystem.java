...
public class NexusTestSystem
    extends NexusTestSystemSupport<RepositoryRule, CapabilitiesRule>
{
  @Inject
  public NexusTestSystem(
      final CapabilityRegistry capabilityRegistry,
      final RepositoryManager repositoryManager)
  {
    super(new RepositoryRule(() -> repositoryManager), new CapabilitiesRule(() -> capabilityRegistry));
  }
}
