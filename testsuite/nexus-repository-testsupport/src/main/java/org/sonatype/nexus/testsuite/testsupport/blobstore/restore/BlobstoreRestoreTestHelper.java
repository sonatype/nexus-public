 ...
 */
public class BlobstoreRestoreTestHelper
{
  ...
  public void runRestoreMetadataTaskWithTimeout(long timeout) {
  ...
  public Asset assertAssetMatchesBlob(final Repository repository, final String name) {
